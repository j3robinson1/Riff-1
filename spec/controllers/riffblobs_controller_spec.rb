  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved riffblob as @riffblob" do
        ...
        post :create, {:riffblob => { "name" => "invalid value" }}, valid_session
        assigns(:riffblob).should be_a_new(Riffblob)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested riffblob" do
        ...
        Riffblob.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => riffblob.to_param, :riffblob => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the riffblob as @riffblob" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Riffblob.any_instance.stub(:save).and_return(false)
        put :update, {:id => riffblob.to_param, :riffblob => { "name" => "invalid value" }}, valid_session
        assigns(:riffblob).should eq(riffblob)
      end
